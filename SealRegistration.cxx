...
int main(int argc, char * argv[])
{
  ...
  JHCTPointSetMetricType::Pointer metric = JHCTPointSetMetricType::New();
    // Finish setting up the metric
  metric->SetFixedPointSet( thermalPhaseSymmetryPointSet );
  metric->SetMovingPointSet( opticalPhaseSymmetryPointSet);
  ...
  PointSetMetricRegistration<AffineTransformType, JHCTPointSetMetricType, PointSetType >
